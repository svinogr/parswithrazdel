package info.upump.parswithrazdel.db;
...
public class QuestionDAO extends DBDAO {
    ...
    public long save(Question question) {
        ...
        cv.put(DataBaseHelper.TABLE_KEY_CATEGORY, question.getPart().getId());
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    question.setPart(new Part(Integer.parseInt(stringToUpperCase(cursor.getString(2)))));
